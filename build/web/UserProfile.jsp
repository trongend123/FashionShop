<%-- 
    ...
    Created on : Feb 24, 2023, 3:52:56 PM
    Author     : ASUS
--%>
        ...
        <div class="userProfile">
            ...
            <div class="user-profile-left">
                ...
                <div class="user-profile-left-option">
                    ...
                    <p><Button onclick="location.href = 'wishList?userId=${sessionScope.account.getUserId()}&option=show'">Wish List</Button></p>
                    <p><Button onclick="location.href = 'ordersHistory?userId=${sessionScope.account.getUserId()}?option=show'">History Orders</Button></p>
            ...
            <div class="user-profile-right">
                <form action="editUserProfile" method="POST" id="formEditProfile">
                    ...
                    <table class="edit-table-profile">
                        ...
                        <tr>
                            <td><select name="editCityName" id="editCityId">     
                                    <option value="${account.getCity()}">${account.getCity()}</option>
                                </select>
                            </td>

                            <td><select name="editDistrictname" id="editDistrictId">
                                    <option value="${account.getDistrict()}">${account.getDistrict()}</option>
                                </select></td>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="editAddressName" id="editAddressId" value="${sessionScope.account.getAddress()}" ></td>
                        </tr>
                ...
                <tr>
                    <td><p id="updateNotification" style="color: red; font-size: 18px;">${updateNotification}</p></td>
